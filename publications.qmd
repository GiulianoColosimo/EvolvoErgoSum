...
My publications organized in different tables for the ones that have been peer reviewed, the ones that are still undergoing the process, and other more general publications. The title of each publication is actually a link to either the official journal page where it was published or to a repository where you can find a PDF copy of it. If the link doesn't work (or currently is not available) the cell will have a gold-ish backgorund color. I periodically check this list and the link to make sure that it is up to date.
